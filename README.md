 ...
 HTML: Estrutura a interface do usuário, como o campo de entrada, botões e os contêineres de visualização.
 
 CSS: Aplica o design moderno em modo escuro (dark mode) e gerencia o layout responsivo da página.
